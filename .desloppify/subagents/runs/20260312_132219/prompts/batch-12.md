...
Batch rationale: seed files for package_organization review
...
- STANDALONE_APP.py
- analysis/Uniprot_TMD_search.py
- analysis/demo_fixed_workflow.py
...
9. Complete `dimension_judgment` for your dimension — all three fields (strengths, issue_character, score_rationale) are required. Write the judgment BEFORE setting the score.
